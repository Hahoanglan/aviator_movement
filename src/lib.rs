...
pub mod prelude {
    ...
    pub use crate::{
        ...
        input::{
            Climbdown, Crane, Crouch, GlobalMovement, Jump, Mantle, Movement, RotateCamera, Slide, Sprint, SwimUp,
            Tac, YankCamera,
        },
...
pub struct CharacterController {
    ...
    pub slide_friction_scale: f32,
    pub slide_min_speed: f32,
    pub slide_steer_rate: f32,
    pub slide_boost: f32,
    /// Maximum seconds a single slide can last before it force-ends.
    pub slide_max_duration: f32,
    /// Seconds before the player can start another slide after one ends.
    pub slide_cooldown_duration: f32,
}
...
impl Default for CharacterController {
    fn default() -> Self {
        Self {
            ...
            standing_view_height: 1.8,
            crouch_view_height: 1.0,
            ...
            slide_friction_scale: 0.15,
            slide_min_speed: 3.0,
            slide_steer_rate: 2.0,
            slide_boost: 1.35,
            slide_max_duration: 1.3,
            slide_cooldown_duration: 0.8,
        }
    }
}
